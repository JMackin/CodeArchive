...
public class A1
{
    ...
    public void set(String value, int index)
    {
        if ( index < count )
          ...
          throw new java.lang.ArrayIndexOutOfBoundsException("Cannot set beyond the end of the array");
    }
    ...
    public void insert(String string, int index)
    {
        ...
        else if ( index == count) //Insert at the end of the array
        {
           ...
           throw new java.lang.ArrayIndexOutOfBoundsException("Cannot insert beyond the end of the array");
    }
    ...
    public void delete(int index)
    {
        ...
        {
            throw new java.lang.ArrayIndexOutOfBoundsException("Cannot delete beyond the end of the array");
        }
    }

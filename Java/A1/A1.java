...
public class A1<X>
{
    ...
    public X get(int index)
    {
        ...
        {
          System.out.println("Cannot get beyond the end of the array");
          return null;
        }
    }
    ...
    public void set(X value, int index)
    {
        if ( index < count )
          ...
          System.out.println("Cannot set beyond the end of the array");
    }
    ...
    public void insert(X string, int index)
    {
        ...
        else if ( index == count) //Insert at the end of the array
        {
            ...
            System.out.println("Cannot insert beyond the end of the array");
    }
    ...
    public void delete(int index)
    {
        ...
        {
            System.out.println("Cannot delete beyond the end of the array");
        }
    }
